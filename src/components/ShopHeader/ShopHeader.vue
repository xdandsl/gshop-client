...
<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowDiscounts=true">
    ...
    <div class="activity-sheet" v-if="isShowDiscounts">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
          优惠活动</h2>
        <ul class="list">
          <!--如何实现：如何根据type，给对应li添加对应的active-green类  type=0,activity-green type=0,activity-red-->
  ...
  export default {
    data(){
      return {
        ...
        isShowBulletin: false,//公告是否显示
        isShowDiscounts: false, //优惠是否显示
      }
    },
    computed: {
      ...mapState({
